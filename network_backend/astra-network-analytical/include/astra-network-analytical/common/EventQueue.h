...
class EventQueue {
  public:
    ...
    /**
      * 
      * Add arrival requests to the event queue
      *
      */
    void add_arrival(int req_id) noexcept;

    /**
      * 
      * Process and return all arrival requests
      *
      */
    std::vector<int> get_and_clear_arrivals() noexcept;
